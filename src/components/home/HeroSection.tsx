...
export default function HeroSection() {
  return (
    <section className="relative h-screen min-h-[600px] max-h-[900px] flex items-center overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#2d1533] via-[#a61c82] to-[#fc69cd]">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="max-w-3xl">
          ...
          <p className="animate-fade-up text-plum-primary-container/90 text-xs font-bold uppercase tracking-[0.2em] mb-5">
            UK Plastic Packaging Manufacturer
          </p>

          {/* Headline */}
          <h1 className="animate-fade-up delay-100 font-display font-bold text-white leading-tight mb-6"
            style={{ fontSize: "clamp(2.5rem, 5.5vw, 4.5rem)", lineHeight: 1.05, letterSpacing: "-0.02em" }}>
            Precision Packaging<br />
            <span className="text-plum-primary-container">for UK Industry</span>
          </h1>

          {/* Subheadline */}
          <p className="animate-fade-up delay-200 text-white/75 text-lg md:text-xl leading-relaxed mb-10 max-w-xl">
            Thermoformed trays, containers and bespoke packaging solutions — designed, tested and manufactured in the UK.
          </p>
